...
async function callOpenAI(apiKey: string, model: string, message: string, instructions: string): Promise<string> {
...
async function callAnthropic(apiKey: string, model: string, message: string, instructions: string): Promise<string> {
  const response = await axios.post(
...
async function callGemini(apiKey: string, model: string, message: string, instructions: string): Promise<string> {
  const response = await axios.post(
